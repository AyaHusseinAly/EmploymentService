...
-- such as removing double quotes in tables names
...
-- Adjust sequence to the highest ID we inserted for next inserts to have no issues
...
-- Adjust sequence
SELECT setval(pg_get_serial_sequence('"Salaries"', 'ID'), (SELECT MAX("ID") FROM "Salaries"));